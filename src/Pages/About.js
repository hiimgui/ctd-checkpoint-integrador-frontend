                ...
                <div className="title d-flex flex-column flex-sm-row justify-content-space-around align-items-center">
                    <div className="Cards">
                        <Card className="CardStyle" style={{ width: '16rem' }}>
                            ...
                            <Card.Body>
                                <a href="https://" className="icons" target="_blank" rel="noopener noreferrer"><BsGithub /></a>
                                <a href="https://" className="icons" target="_blank" rel="noopener noreferrer"><FaLinkedin /></a>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className="Cards">
